...
namespace krypto::math {
	 ...
	 * Used to do fast Mix column operation
	 */
	struct aes_mult_tables {
		std::array<uint8_t, 256> mult_2{};
		std::array<uint8_t, 256> mult_3{};
		std::array<uint8_t, 256> mult_9{};
		std::array<uint8_t, 256> mult_11{};
		std::array<uint8_t, 256> mult_13{};
		std::array<uint8_t, 256> mult_14{};
	};
	...
	/**
	 * Create precomputed multiplication tables in GF(2^8)
	 * https://en.wikipedia.org/wiki/Rijndael_MixColumns
	 */
	constexpr aes_mult_tables compute_aes_mult_tables() {

		aes_mult_tables tables{};
		tables.mult_2 = {	0x00,0x02,0x04,0x06,0x08,0x0a,0x0c,0x0e,0x10,0x12,0x14,0x16,0x18,0x1a,0x1c,0x1e,
		...
		tables.mult_3 = {	0x00,0x03,0x06,0x05,0x0c,0x0f,0x0a,0x09,0x18,0x1b,0x1e,0x1d,0x14,0x17,0x12,0x11,
		...
		tables.mult_9 = {	0x00,0x09,0x12,0x1b,0x24,0x2d,0x36,0x3f,0x48,0x41,0x5a,0x53,0x6c,0x65,0x7e,0x77,
		...
		tables.mult_11 = {	0x00,0x0b,0x16,0x1d,0x2c,0x27,0x3a,0x31,0x58,0x53,0x4e,0x45,0x74,0x7f,0x62,0x69,
		...
		tables.mult_13 = {	0x00,0x0d,0x1a,0x17,0x34,0x39,0x2e,0x23,0x68,0x65,0x72,0x7f,0x5c,0x51,0x46,0x4b,
		...
		tables.mult_14 = {	0x00,0x0e,0x1c,0x12,0x38,0x36,0x24,0x2a,0x70,0x7e,0x6c,0x62,0x48,0x46,0x54,0x5a,
